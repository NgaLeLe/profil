				...
				<form method="post" action="formulaire">
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							...
							if (error == "2") {
								out.print(
								"<small id=\"emailHelpBlock\" class=\"form-text text-muted\"> Votre email ne valide pas,  mail doit contenir @aaa.ccc ! </small>");
							}
							%>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<input type="password" name="iptPassword" class="form-control"
								id="inputPassword3" placeholder="email@yahoo.com"
								value="${password}">
							<%
								if (error == "4") {
								out.print(
								"<small id=\"passwordHelpBlock\" class=\"form-text text-muted\"> Votre password est incorrect ! </small>");
							}
							%>
						</div>
					</div>
